...
const { createIssue, getAllIssues, getMyIssues, updateIssue, deleteIssue, upvoteIssue, downvoteIssue, addComment, getNearbyIssues, acceptIssue, rejectIssue, getIssueById } = require('../controllers/issueController');
